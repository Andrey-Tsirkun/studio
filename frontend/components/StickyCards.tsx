"use client";
import styles from "../styles/components/StickyCards.module.scss";
...
const StickyCards: React.FC = () => {
  ...
  useGSAP(
    () => {
      const stickyCards = document.querySelectorAll(`.${styles.stickyCard}`);
        ...
        <div className={styles.stickyCard} key={index}>
          ...
          <div className={styles.stickyCardContent}>
            <div className={styles.stickyCardContentWrapper}>
              <h1 className={styles.stickyCardHeader}>{cardData.title}</h1>
